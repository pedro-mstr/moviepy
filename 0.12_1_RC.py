...
# Videos Directories
input_dir = r"F:\Youtube\moviepy\Clips_To_Merge\1"
...
number_font_dir = r"F:\\Youtube\\fonts\\CuteMeow-51Pra.otf"
number_fontsize = 240
number_color = "rgba(173,217,230,1)"
number_stroke_color = "white"
number_stroke_width = 2
number_position_x = 60
number_position_y = 200
...
def add_random_emojis_to_clips(clip_list, image_dir):
    for i, clip in enumerate(clip_list):
        ...
        image = image.set_position((800, 200))
...
while file_list:
    ...
    if clips_to_merge:
        ...
        # Add Channel Name Overlay & Call to Action
        clips_to_merge = add_channel_calltoaction_to_clips(clips_to_merge, overlay_dir)
